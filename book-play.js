...
$(function(){
    ...
    // ===== List 생성하기 =====
    addItem('THINGS THAT SURPRISE YOU', 'JENNIFER MASCHRI', './book-play-list/00.png', './book-play-list/00.mp3');
    addItem('Unseen World', 'JAMILLA FRAMCIS', './book-play-list/01.png', './book-play-list/01.mp3');
    addItem('Lonely Grizzly', 'MOISES DRAKEFORD', './book-play-list/02.png', './book-play-list/02.mp3');
    addItem('Three Blind Mice', 'DAVID CUERRERO', './book-play-list/03.png', './book-play-list/03.mp3');
    addItem('The little Cat', 'ISAAC SCOTT', './book-play-list/04.png', './book-play-list/04.mp3');
    addItem('My Birthday Wish', 'EDISON MCPHEE', './book-play-list/05.png', './book-play-list/05.mp3');
    addItem('Wake Up! Rabby!', 'ALICE BECKETH', './book-play-list/06.png', './book-play-list/06.mp3');
    addItem('Animals in the Great Forest', 'MARLENE M.PARSON', './book-play-list/07.png', './book-play-list/07.mp3');
    addItem('Once Upon a Time', 'MARTHINA SMITH', './book-play-list/08.png', './book-play-list/08.mp3');
    addItem('Explore the Stars', 'JOSE HAWRTHONE', './book-play-list/09.png', './book-play-list/09.mp3');
    addItem("It's Snowing Lupo!", 'MARIKA MAIJALA', './book-play-list/10.png', './book-play-list/10.mp3');
    addItem('The Doe in the Forest', 'LAURA TOVEN', './book-play-list/11.png', './book-play-list/11.mp3');
    ...
    $(window).resize(function(){
        let pos = 0.5 * window.innerWidth - 82.5 - 205 * currentPlaying;
